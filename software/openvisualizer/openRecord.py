...
def recordMacStats(motePort,input):
   ...
   if (lastSyncCounter != recordElements[motePort]["syncCounter"]):
      global lastSyncCounter
      lastSyncCounter  = recordElements[motePort]["syncCounter"]
      printTime = datetime.now() - startTime
      f = open('C:/Users/David/test.txt', 'a')
      f.write(str(printTime.seconds) + "." + str(printTime.microseconds) + "," + str(recordElements[motePort]["syncCounter"]) + "," + str(recordElements[motePort]["minCorrection"]) + "," + str(recordElements[motePort]["maxCorrection"]) + "," + str(recordElements[motePort]["numDeSync"]) + "\n")
      print str(printTime.seconds) + "." + str(printTime.microseconds) + "," + str(recordElements[motePort]["syncCounter"]) + "," + str(recordElements[motePort]["minCorrection"]) + "," + str(recordElements[motePort]["maxCorrection"]) + "," + str(recordElements[motePort]["numDeSync"])
